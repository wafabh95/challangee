...
export default class Formulaire extends Component {
  ...
  Submit = () => {
    ...
    this.setState({ ...this.state, contact: [...this.state.contact, this.state.info], show: true })
  ...
  render() {
    ...
    return (
      ...
      <div className='formultwo'>
        <h1 className='formulaire'>Formulaire:</h1>
        ...
        <Form className="forma">
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control type="text" placeholder="Enter Name" name='age' onChange={this.add} />
            <Form.Text className="text-muted">
          ...
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control type="text" placeholder="Enter lastname" name='url' onChange={this.add} />
            <Form.Text className="text-muted">
        ...
        {this.state.show == true ? this.state.contact.map((el, index) =>
